...
export default function BuildingSVG(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      version="1.0"
      id="Layer_1"
    ...
    >
      <g>
        ...
        />
        <rect x="26" y="30" fill="currentColor" width="2" height="2" />
        <rect x="26" y="40" fill="currentColor" width="2" height="2" />
        <rect x="29" y="54" fill="currentColor" width="6" height="10" />
        <rect x="8" y="50" fill="currentColor" width="2" height="2" />
        <rect x="26" y="10" fill="currentColor" width="2" height="2" />
        <rect x="26" y="20" fill="currentColor" width="2" height="2" />
        <rect x="36" y="20" fill="currentColor" width="2" height="2" />
        <rect x="36" y="10" fill="currentColor" width="2" height="2" />
        <rect x="36" y="30" fill="currentColor" width="2" height="2" />
        <rect x="36" y="40" fill="currentColor" width="2" height="2" />
        <rect x="8" y="40" fill="currentColor" width="2" height="2" />
        <path
          fill="currentColor"
        ...
        />
        <rect x="54" y="50" fill="currentColor" width="2" height="2" />
        <rect x="54" y="40" fill="currentColor" width="2" height="2" />
        <rect x="54" y="30" fill="currentColor" width="2" height="2" />
        <path
          fill="currentColor"
        ...
        />
        <rect x="8" y="30" fill="currentColor" width="2" height="2" />
        <rect x="8" y="20" fill="currentColor" width="2" height="2" />
      </g>
    </svg>
  );
}
