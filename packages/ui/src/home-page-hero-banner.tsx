      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 z-20 flex w-full flex-col p-4 text-primary-foreground md:p-10 xl:p-20">
          <div className="mb-4 xl:mb-8">
            {/* DealCountdownHeroBanner (optional) */}
          </div>

          {/* Title */}
          <h1 className="!line-clamp-4 inline-block overflow-hidden text-ellipsis text-3xl font-bold uppercase !leading-[1.2] md:line-clamp-3 xl:line-clamp-2 xl:text-7xl">
            {title}
          </h1>

          {/* Subtitle (optional) */}
          {subtitle && (
            <h2 className="!line-clamp-4 inline-block overflow-hidden text-ellipsis text-base !leading-[1.2] md:line-clamp-3 xl:line-clamp-2 xl:text-3xl">
              {subtitle}
            </h2>
          )}
